...
public class QueryService
{
    ...
    public static async ValueTask<ReadOnlyObservableCollection<Departments>> JsonDeserializeIObservable(string token, string queryUrl, string httpMethod) 
    {
...
#pragma warning restore SYSLIB0014 // Тип или член устарел
        ...
        return JsonSerializer.Deserialize<ReadOnlyObservableCollection<Departments>>(await reader.ReadToEndAsync())
